...
export default class Login {
  ...
  handleSubmitAdmin = (e) => {
    ...
    const user = {
      type: "Admin",
      // ***   remplacement de  employee-email-input par admin-email-input car dans fonction SubmitAdmin
      // ***   utilisation de la console  et du debugger pour connaitre les value
      email: e.target.querySelector(`input[data-testid="admin-email-input"]`)
        .value,
      // *** remplacement de  employee-password-input par admin-password-input car dans fonction SubmitAdmin
      password: e.target.querySelector(
